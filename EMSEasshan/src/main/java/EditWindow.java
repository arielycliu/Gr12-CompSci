...
public class EditWindow extends javax.swing.JFrame {
    ...
    private void bEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditActionPerformed
        ...
        if (num == -1) {
            System.out.println("Please search for an employee first");
            return;
        }
        theHT.removeEmployee(num); // remove so you don't get duplicates if you change emp num
        ...
        if (theHT.searchByEmployeeNumber(empNum) != null) {
            System.out.println("Employee number already taken");
            return;
        }
        ...
        if (type == "FTE") {
            ...
            System.out.println("Successfully edited employee #" + emp.geteN());
        } else if (type == "PTE") {
    ...
    private void bDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDeleteActionPerformed
        ...
        theHT.removeEmployee(num); // remove
